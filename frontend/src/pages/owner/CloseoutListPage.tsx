...
export default function CloseoutListPage() {
  ...
  return (
    <div className="page-container">
      <div className="page-header">
        <h1>Project Closeouts</h1>
        <p>View and manage closeout processes across all projects</p>
      </div>
      ...
      <div className="projects-grid">
        {projects.map((project) => (
          <Link
            key={project.id}
            to={`/owner/projects/${project.id}/closeout`}
